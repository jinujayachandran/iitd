...
\begin{eqnarray}
	SP &\triangleq& \frac{\rho_b\beta_{lkl}\eta_{lk}}{M\gamma_{lk}^{l}}\pmb{E}[||\pmb{\hat  g}_{lkl}||^2]\pmb{E}[s_{lk}^Hs_{lk}] \nonumber \\
...
\begin{eqnarray}\label{eq:noiseF1}
	V_1 &\triangleq& \frac{\rho_b \beta_{lkl} \eta_{lk}}{M\gamma_{lk}}   \pmb{E}[|s_{lk}\left(||\pmb{\hat g}_{lkl}||^2- \pmb{E}[||\pmb{\hat  g}_{lkl}||^2] \right)|^2] \nonumber \\
	    ...
	    &=& \rho_bM\beta_{lkl}\eta_{lk}\gamma_{lk}
\end{eqnarray}
...
\begin{eqnarray}\label{eq:noiseF2}
	V_2 &\triangleq& \frac{\rho_b\eta_{lk}}{M\gamma_{lk}} \pmb{E}\left[\Bigm| \pmb{\hat g}_{lkl}  \left(\sum_{\substack{k'=1 \\ k' \neq k}}^{K} \sqrt{\frac{\eta_{jk'}}{M\gamma_{lk'}}} \ \pmb{\hat g}^*_{lk'l} \ s_{lk'l} (t)\right)\Bigm|^2\right] \nonumber \\
        &=& \frac{\rho_b\eta_{lk}}{M\gamma_{lk}} \sum_{\substack{k'=1 \\ k' \neq k}}^{K} \pmb{Tr}\left(\pmb{E}\left[\Bigm| \pmb{\hat g}_{lkl} \ \pmb{\hat g}_{lkl}^H \ \pmb{\hat g}_{lk'l} \ \pmb{\hat g}_{lk'l}^{H} \right]\right) \nonumber \\
...
\begin{eqnarray}\label{eq:noiseF3}
    ...
    &=& \rho_b\sum_{\substack{j=1 \\ j \neq l}}^{L} \sum_{k'=1}^{K} \frac{\eta_{jk'}}{M\gamma_{jk'}} \pmb{Tr}\left(\pmb{E}\left[\Bigm| \pmb{\hat g}_{lkl} \ \pmb{\hat g}_{lkl}^H \ \pmb{\hat g}_{jk'l} \ \pmb{\hat g}_{jk'l}^{H} \right]\right) \nonumber \\
...
\begin{eqnarray}\label{eqn:noiseF4}
	V_4 &\triangleq& \rho_b \pmb{E} \left[ \Bigm |\sum_{j=1}^{L} \pmb{\widetilde{g}}_{lkl}^T \left(\sum_{k'=1}^{K} \sqrt{\frac{\eta_{jk'}}{M\gamma_{jk'}}} \ \pmb{\hat g}^*_{jk'j} \ s_{kj} (t)\right)\Bigm|^2 \right] \nonumber \\
     &=& \rho_b\sum_{j=1}^{L} \sum_{k'=1}^{K} \frac{\eta_{jk'}}{M\gamma_{jk'}} \pmb{Tr}\left(\pmb{E}\left[\Bigm| \pmb{\widetilde{g}}_{lkl} \ \pmb{\widetilde{g}}_{lkl}^H \ \pmb{\hat g}_{jk'l} \ \pmb{\hat g}_{jk'l}^{H} \right]\right) \nonumber \\
